...
- Persönliche Passagen folgen der Gastgeberstimme aus `docs/VOICE.md`.
- Konkrete Namen und Tätigkeiten sind anonymer Werbesprache vorzuziehen.
- Preise, Öffnungszeiten, Termine, Pferdedaten und rechtliche Angaben bleiben bewusst sachlich.
- Die redaktionellen Überschriften dürfen charaktervoll sein; der Fließtext bleibt natürlich und leicht verständlich.
